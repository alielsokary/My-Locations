    ...
    func listenForBackgroundNotification() {
        observer = NotificationCenter.default.addObserver(forName: Notification.Name.UIApplicationDidEnterBackground, object: nil, queue: OperationQueue.main) {
            ...
            if let stronSelf = self {
                if stronSelf.presentedViewController != nil {
                    stronSelf.dismiss(animated: false, completion: nil)
                }
                stronSelf.descriptionTextView.resignFirstResponder()
        }
        }
    }
